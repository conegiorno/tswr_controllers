...
class CEMController(Node):
    ...
    def cem_controll(self, pose: PoseStamped):
        ...
        di = self.cem_steer_control(current_state, dst)
    ...
    def cem_steer_control(self, state: State, Lf):
    ...
    def publish_control(self, steer, accel):
        ...
        acc_msg.lateral.steering_tire_angle = steer # + left / - right
...
def main(args=None):
    ...
    cem_controller = CEMController()

    rclpy.spin(cem_controller)

    # Destroy the node explicitly
    # (optional - otherwise it will be done automatically
    # when the garbage collector destroys the node object)
    cem_controller.destroy_node()
    rclpy.shutdown()
